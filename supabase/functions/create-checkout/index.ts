...
serve(async (req) => {
  ...
  try {
    ...
    // Map planId to Stripe priceId
    const priceId = {
      'monthly': 'price_1RDxMLF8ZVI3gHwE4BYIgzy1',     // R$ 47,00
      'semi_annual': 'price_1RDxRCF8ZVI3gHwEhCAB049h', // R$ 145,00
      'annual': 'price_1RDxRCF8ZVI3gHwEbf17KfeO'       // R$ 193,00
    }[planId];
